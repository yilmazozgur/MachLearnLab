...
ExperimentName='KITTI'; %'CIFAR10_SingleLayer', 'PennTreeBank_Character_CA', 'KITTI'
fprintf(strcat('EXPERIMENT: ', ExperimentName,'\n'));

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Dataset name
DatasetName='KITTI'; %'CIFAR10', 'PennTreebank_Character', 'KITTI'
%LoadData options
...
optionsExtractFeatures.BatchSize=40;%100;
...
optionsBriefFeatureExtraction.Dimension='2D'; %'2D', '3D'; If you select 3D then be carefull to below parameters(give the high number for NumberOfTests(1))
...
optionsBriefFeatureExtraction.NumberOfTests=[64 64 64]; %Number of extracted bits per patches, 
...
optionsBriefFeatureExtraction.PatchSize=[4 4]; % '[8 8]', Be careful while choosing these parameters
...
optionsPoolFeatures.SummationType='Coarse'; %'Coarse' 'Fine', 'Finest', 'Coarse', 'Single', or 'None' (Not recommended!)
...
optionsSupervisedLearning.Epochs=10; %WARNING: Should be set to 1, if Ensemble learning is used.
