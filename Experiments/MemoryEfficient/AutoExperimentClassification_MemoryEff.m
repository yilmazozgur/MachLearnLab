function AutoExperimentClassification_MemoryEff(Epoch,lamda)
...
% ParametersClassification_Alisher; % 'ParametersClassification', 'ParametersClassification_Alisher'
[NumberOfRFs,rfSize,DatasetName,optionsAll]=AutoParametersClassification_Alisher(Epoch,lamda);
%put every option in a list, for monolithic feature computation in one
%function.
optionsData=optionsAll{1};
optionsExtractFeatures=optionsAll{2};
optionsPoolFeatures=optionsAll{3};
optionsNormalizeBinarize=optionsAll{4};
optionsExpansion=optionsAll{5};
optionsSupervisedLearning=optionsAll{6};
optionsEvaluation=optionsAll{7};
optionsKmeans=optionsAll{8};
optionsBriefFeatureExtraction=optionsAll{9};
RootPath=optionsAll{10};
...
ReceptiveFields=KmeansUnsupervised(DatasetRaw,NumberOfRFs,rfSize,optionsAll);
    ...
    case 'ExtractBRIEF'
        switch optionsAll{9}.Type
            case 'BriefOverlappedPatches'
                FigureName=strcat('F:\Recurrent Holistic Vision v0.4\MatlabCode\BRIEF\BriefOverlappedPatches\MeanCrossValidationAccuracies\',int2str(optionsAll{1}.TotalNumberOfBatches),'_Batches-',optionsAll{9}.Dimension,';MeanCVaccuracy;Epoch=',int2str(optionsAll{6}.Epochs),';',int2str(optionsAll{6}.MaxIter),';',optionsAll{9}.ColorType,';[',int2str(optionsAll{9}.PatchSize(1)),'x',int2str(optionsAll{9}.PatchSize(1)),'];',int2str(optionsAll{9}.Stride),';[',int2str(optionsAll{9}.NumberOfTests(1)),',',int2str(optionsAll{9}.NumberOfTests(2)),',',int2str(optionsAll{9}.NumberOfTests(3)),'];',int2str(optionsAll{9}.SmoothingFlag),';',num2str(optionsAll{6}.lambda),'.fig');
                h=figure;
                plot(MeanCVAccuracy);
            ...
            case 'BriefSubImages'
                FigureName=strcat('/home/comp2/Desktop/Alisher/MatlabCode/BRIEF/BriefSubImages/MeanCrossValidationAccuracies/',int2str(optionsAll{1}.TotalNumberOfBatches),'_Batches-','MeanCVaccuracy;Epoch=',int2str(optionsAll{6}.Epochs),';',int2str(optionsAll{6}.MaxIter),';',optionsAll{9}.ColorType,';',optionsAll{3}.SummationType,';[',int2str(optionsAll{9}.NumberOfTests(1)),',',int2str(optionsAll{9}.NumberOfTests(2)),',',int2str(optionsAll{9}.NumberOfTests(3)),'];',int2str(optionsAll{9}.SmoothingFlag),';',num2str(optionsAll{6}.lambda),'.fig');
                h=figure;
                plot(MeanCVAccuracy);
                savefig(h,FigureName);
                close (h);
